...
class Pokemon:
    def __init__(self, id, moves=None, hp=None, attack=None, defense=None, special_attack=None, special_defense=None, speed=None,types=None, name="", current_mon=False, description=""):
        """
